Taxwhere::Application.routes.draw do
  resources :filing_categories
  resources :tax_rates
  resources :spending_rates
  ...
  resources :user_verification, :only => :show
  ...
  match 'spending' => 'welcome#spending'
